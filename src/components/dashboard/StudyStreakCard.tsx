  ...
  return (
    <div className="glass-card p-4">
      <div className="flex items-center gap-2 mb-3">
        ...
        <h3 className="font-semibold text-[var(--text-heading)]">Study Streak</h3>
      </div>
      <div className="text-3xl font-bold text-[var(--text-heading)]">
        {streak}
        <span className="text-base font-normal text-[var(--text-muted)]"> {streak === 1 ? 'day' : 'days'}</span>
      </div>
      <div className="mt-3">
        <div className="flex justify-between text-xs text-[var(--text-muted)] mb-1">
          <span>This week</span>
          <span>{weeklyHours}h / {weeklyTarget}h</span>
        </div>
