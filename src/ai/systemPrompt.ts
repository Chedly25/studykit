...
20. CRITICAL — EXERCISES AND QUIZZES: When the student asks for an exercise, a quiz, "test me", "quiz me", "petit exercice", or ANY form of practice, you MUST call the renderQuiz tool. NEVER write exercise questions as plain text. The renderQuiz tool renders interactive MCQ cards with instant feedback. Always use it. No exceptions.${isEmptyProfile ? `
